...
public class StylusUI {
    ...
    public static void aplicarEstiloBoton(JButton boton, Boolean relleno) {
        ...
        boton.setFont(FUENTE_TEXTO.deriveFont(12f));  // Tama�o de fuente reducido
        boton.setFont(boton.getFont().deriveFont(Font.BOLD)); // Bold para mas volumen(?
        boton.setFocusPainted(false);
        boton.setBorder(new BordeRedondeado(10));  // Borde redondeado m�s peque�o
        // Ajustar m�rgenes muy peque�os para hacer el bot�n m�s compacto
       ...
       if (!relleno){
        ...
        preferredSize.width += PADDING_HORIZONTAL * 2; // A�adir espacio horizontal adicional
    ...
    public static void aplicarEstiloTabla(JTable tabla, boolean reajustar) {
        ...
        tabla.setFillsViewportHeight(true);   // Llenar el �rea de la tabla, incluso cuando est� vac�a
        ...
        // Bordes y selecci�n
        tabla.setGridColor(COLOR_SECUNDARIO);         // Color de las l�neas de la tabla
        tabla.setSelectionBackground(COLOR_SECUNDARIO.darker());  // Fondo de selecci�n
        tabla.setSelectionForeground(COLOR_TEXTO);    // Texto de selecci�n
    ...
    public static void ajustarAnchoColumnas(JTable tabla) {
        ...
        for (int i = 0; i < tabla.getColumnCount(); i++) {
            ...
            column.setPreferredWidth(maxWidth + 10); // A�adir un margen adicional para el espaciado
        }
    }
    ...
    public static void aplicarEstiloDialogo(JDialog dialog) {
        ...
        dialog.pack(); // Ajustar el tama�o del di�logo seg�n su contenido
    ...
    public static void aplicarEstiloComboBox(JComboBox<?> comboBox) {
        ...
        // Estilo de los �tems desplegados
    ...
    public static void aplicarEstiloRadioButton(JRadioButton radioButton) {
        ...
        // Personaliza el �cono seleccionado
...
//  No funciona bien, tengo que econtrar manera de pasar la clase y que trate automaticamente todos los elementos
    ...
    public static void ajustarDialogo(JDialog dialog, String texto) {
        ...
        // Ajustar el dise�o del JDialog para que se ajuste al texto
    ...
    public static void styleMenuItem(JMenuItem menuItem) {
        ...
        // Cambiar color al pasar el ratón (hover)
        menuItem.addChangeListener(e -> {
            if (menuItem.getModel().isRollover()) {
                menuItem.setBackground(new Color(60, 60, 60));  // Fondo más claro en hover
            } else {
                menuItem.setBackground(new Color(45, 45, 45));  // Fondo original
            }
        });

        // Borde opcional para mejorar la estética
        menuItem.setBorder(BorderFactory.createEmptyBorder(5, 10, 5, 10));

        // Deshabilitar relleno si el estado está deshabilitado
